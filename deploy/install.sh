...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/gwenliu1025/yuluoapi/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="gwenliu1025/yuluoapi"
...
Documentation=https://github.com/gwenliu1025/yuluoapi
...
main() {
    ...
    case "${1:-}" in
        ...
        --help|-h)
            ...
            echo "  $0 upgrade -v v0.2.003      # Upgrade to specific version"
