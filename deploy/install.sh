...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/gwenliu1025/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="gwenliu1025/sub2api"
...
Documentation=https://github.com/gwenliu1025/sub2api
