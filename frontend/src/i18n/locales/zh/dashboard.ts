export default {
  ...
  modelPlaza: {
    ...
    table: {
      ...
      cacheWriteShort: '写',
      cacheReadShort: '读',
      cacheReadImplicit: '隐式读取',
      cacheReadExplicit: '显式读取',
      cacheReadImplicitShort: '隐式读',
      cacheReadExplicitShort: '显式读',
      ...
      timePricingStandard: '其他时段',
      timePricingStandardHint: '按 {timezone} 时间，未单独列出的其他时段使用本行标准价',
