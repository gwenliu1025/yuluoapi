              ...
              <table class="w-full">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="px-4 py-3 text-sm tabular-nums text-right font-medium text-gray-900 dark:text-white">{{ cny(row.actual_cost != null ? row.actual_cost : row.cost) }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
.input-ring:focus {
  box-shadow: 0 0 0 3px rgba(45, 123, 112, 0.2);
  border-color: #2d7b70;
  outline: none;
}
