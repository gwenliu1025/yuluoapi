...
func TestCalculateImageCost_DefaultPricing(t *testing.T) {
	...
	require.InDelta(t, usdToCNY(0.201), cost.TotalCost, 0.0001)
	require.InDelta(t, usdToCNY(0.201), cost.ActualCost, 0.0001)

	// 多张图片
	cost = svc.CalculateImageCost("gemini-3-pro-image", "2K", 3, nil, 1.0)
	require.InDelta(t, usdToCNY(0.603), cost.TotalCost, 0.0001)
}
...
func TestCalculateImageCost_4KDoublePrice(t *testing.T) {
	...
	require.InDelta(t, usdToCNY(0.268), cost.TotalCost, 0.0001)
}
...
func TestCalculateImageCost_RateMultiplier(t *testing.T) {
	...
	require.InDelta(t, usdToCNY(0.201), cost.TotalCost, 0.0001)   // TotalCost = 0.134 * 1.5
	require.InDelta(t, usdToCNY(0.3015), cost.ActualCost, 0.0001) // ActualCost = 0.201 * 1.5

	// 费率倍数 2.0x
	cost = svc.CalculateImageCost("gemini-3-pro-image", "2K", 2, nil, 2.0)
	require.InDelta(t, usdToCNY(0.402), cost.TotalCost, 0.0001)
	require.InDelta(t, usdToCNY(0.804), cost.ActualCost, 0.0001)
}
...
func TestGetDefaultImagePrice_FallbackHardcoded(t *testing.T) {
	...
	require.InDelta(t, usdToCNY(0.134), cost.TotalCost, 0.0001)
