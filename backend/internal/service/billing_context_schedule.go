...
func sameContextPrices(a, b ContextPricingTier) bool {
	return samePricePtr(a.Input, b.Input) && samePricePtr(a.Output, b.Output) &&
		samePricePtr(a.CacheWrite, b.CacheWrite) && samePricePtr(a.CacheRead, b.CacheRead) && samePricePtr(a.ExplicitCacheRead, b.ExplicitCacheRead) && samePricePtr(a.CacheWrite1h, b.CacheWrite1h)
}
